...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        # process attributes from arguments
        for param in args_list[1:]:
            try:
                ...
                if "." in value:  # float type
                    value = float(value)
                elif value.isdigit():  # integer type
                    value = int(value)

                if "_" in key:  # replace underscores with spaces
                    key = key.replace("_", " ")
    ...
    def do_update(self, args):
        ...
        if not args[2]:
            ...
            c_id = args[2]  # isolate instance id
        ...
        args = args[2:].split(' ')
        if args[2] == '{' and '}' in args[2]:  # contains kwargs dict
            kwargs = args[2]
        else:  # args continue: attribute name and value
            att_name, att_val = args[2].split("=")
            if not att_name:
    ...
    def help_update(self):
        ...
        print("Updates an object, specify with class, id, attribute_name, and value.\n")
